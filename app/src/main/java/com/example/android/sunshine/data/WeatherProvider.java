...
public class WeatherProvider extends ContentProvider {
    ...
    static
    {
        ...
        sUriMatcher.addURI(WeatherContract.CONTENT_AUTHORITY, WeatherContract.PATH_LOCATION + "/#", LOCATION_ID);
    }
...
// "weather/*/*"
            case WEATHER_WITH_LOCATION_AND_DATE:
            {
                ...
                Log.v(LOG_TAG, "getWeatherByLocationSettingAndDate: " + retCursor.getCount());
                break;
            }
// "weather/*"
            case WEATHER_WITH_LOCATION: {
                retCursor = getWeatherByLocationSetting(uri, projection, sortOrder);
                Log.v(LOG_TAG, "getWeatherByLocationSetting: " + retCursor.getCount());
                break;
            }
// "weather"
            case WEATHER: {
                ...
                Log.v(LOG_TAG, "getWeather: " + retCursor.getCount());
                break;
            }
// "location/*"
            case LOCATION_ID: {
                ...
                retCursor = mOpenHelper.getReadableDatabase().query(
                        WeatherContract.LocationEntry.TABLE_NAME,
                        projection,
                        WeatherContract.WeatherEntry._ID + "= '" + _id + "'",
                        selectionArgs,
                        null,
                        null,
                        sortOrder
                );
                Log.v(LOG_TAG, "getLocationID: " + retCursor.getCount());
                break;
            }
// "location"
            case LOCATION: {
                ...
                Log.v(LOG_TAG, "getLocation: " + retCursor.getCount());
                break;
            }
